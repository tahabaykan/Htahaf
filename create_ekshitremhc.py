...
tickers = [
    'ACR PRD','MITT PRA','MITT PRB','CHMI PRA','CIM PRA','CIO PRA','NYMTZ','FBRT PRE','MFA PRB'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekshitremhc.csv', index=False)
print('ekshitremhc.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 