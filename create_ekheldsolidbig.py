...
tickers = [
    'BAC PRB','JPM PRC','MS PRE','MS PRF','MS PRI','MER PRK','DUK PRA','SCHW PRD','HIG PRG'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldsolidbig.csv', index=False)
print('ekheldsolidbig.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 