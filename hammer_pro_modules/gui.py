...
class HammerProGUI:
    ...
    def setup_watchlist_tab(self):
        ...
        ttk.Radiobutton(type_frame, text="En Yüksek FINAL_THG", 
                       variable=self.watchlist_type_var, value="top_final_thg").pack(side='left', padx=5)
        ttk.Radiobutton(type_frame, text="En Düşük FINAL_THG", 
        ...
        self.result_tree = ttk.Treeview(result_frame, columns=('Symbol', 'FINAL_THG', 'Company', 'Status'), show='headings', height=15)
     ...
     def setup_layout_tab(self):
         ...
         self.layout_type_var = tk.StringVar(value="top_final_thg")
         type_frame = ttk.Frame(create_frame)
         type_frame.pack(anchor='w', padx=5, pady=2)
         
         ttk.Radiobutton(type_frame, text="En Yüksek FINAL_THG (20 sembol)", 
                        variable=self.layout_type_var, value="top_final_thg").pack(side='left', padx=5)
         ttk.Radiobutton(type_frame, text="En Düşük FINAL_THG (20 sembol)", 
                        variable=self.layout_type_var, value="bottom_final_thg").pack(side='left', padx=5)
         ...
         self.layout_result_tree = ttk.Treeview(result_frame, columns=('Symbol', 'FINAL_THG', 'Company', 'Status'), show='headings', height=15)
