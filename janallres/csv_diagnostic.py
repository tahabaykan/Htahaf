...
def analyze_csv_structure():
    ...
    print("🔍 janallresRES CSV DIAGNOSTIC TOOL")
    print("=" * 50)
    ...
    try:
        ...
        if missing_columns or missing_score_columns or missing_benchmark_columns:
            ...
            if missing_score_columns or missing_benchmark_columns:
                print("1. janallresres/update_janalldata_with_scores.py dosyasını çalıştırın")
            if missing_columns:
                print("2. CSV birleştirme işlemini yeniden yapın (merge_csvs.py)")
            print("3. janallres uygulamasını yeniden başlatın")
