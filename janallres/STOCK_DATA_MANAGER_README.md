...
- **Dosya**: `janallresapp/stock_data_manager.py`
...
- **Dosya**: `janallresapp/main_window.py`
- **Entegrasyon**: 
...
- **Dosya**: `janallresapp/port_adjuster.py`
- **Özellikler**:
...
```python
from janallresapp.stock_data_manager import StockDataManager
