...
tickers = [
    'CFG PRE','CFR PRB','FITBO','FCNCP','FCNCO','HBANP','HBANM','KEY PRK','KEY PRJ','WBS PRF'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldkuponlukreorta.csv', index=False)
print('ekheldkuponlukreorta.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 