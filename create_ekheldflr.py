...
tickers = [
    'BML PRJ','BAC PRE','BML PRL','BML PRG','BML PRH','GS PRC','GS PRD','GS PRA','MET PRA','MS PRA','TFC PRI','USB PRH','ZIONP'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldflr.csv', index=False)
print('ekheldflr.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 