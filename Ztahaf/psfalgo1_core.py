...
from Ntahaf.utils.reasoning_logger import log_reasoning
from Ntahaf.psfalgo1_chain import PSFAlgo1Chain
from Ntahaf.psfalgo1_orders import PSFAlgo1Orders
from Ntahaf.psfalgo1_utils import PSFAlgo1Utils
...
class PsfAlgo1(PSFAlgo1Chain, PSFAlgo1Orders, PSFAlgo1Utils):
    ...
    def __init__(self, market_data, exclude_list=None, half_sized_list=None, order_manager=None):
        ...
        self.half_sized_list = half_sized_list or []
