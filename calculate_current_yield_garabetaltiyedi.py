...
# CSV dosyasını oku
df = pd.read_csv('nekheldgarabetaltiyedi.csv')
...
# Sonuçları göster
print("=== NEKHELDGARABETALTIYEDI.CSV - CURRENT YIELD ANALİZİ ===")
...
result_df.to_csv('current_yield_garabetaltiyedi.csv', index=False)
print(f"\nSonuçlar 'current_yield_garabetaltiyedi.csv' dosyasına kaydedildi.") 