...
def show_top20_cmon():
    """En yüksek solidity score'lu 20 CMON'u göster"""
    ...
    # CMON bazında gruplandır ve ortalama solidity score'u al
    ...
    print("\n" + "="*120)
    print("EN YÜKSEK SOLIDITY SCORE'LU 20 CMON")
    print("="*120)
    ...
    print("\n" + "="*120)
    print("DETAYLI ANALİZ - TOP 10")
    print("="*120)
    
    for idx, row in top20_cmon.head(10).iterrows():
        rank = idx + 1
