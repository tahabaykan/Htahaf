...
tickers = [
    'ALL PRJ','ANG PRD','APOS','ATH PRE','ATHS','CFG PRH','DCOMG','FGN','HBANL','JXN PRA','KKRT','LNC PRD','MTB PRJ','MBINM','MS PRP','MS PRQ','NEE PRU','RF PRF','RZC','SPNT PRB','SOJF','SYF PRB','BOH PRB','SNV PRE','TPGXL','UMBFO','VLYPN','WTFCN'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekhelddeznff.csv', index=False)
print('ekhelddeznff.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 