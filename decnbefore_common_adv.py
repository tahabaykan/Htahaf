    ...
    try:
        ...
        for port in ports:
            try:
                ...
                connected = True
                print(f"OK IBKR {port} portu ile bağlantı başarılı!")
                break
...
def main():
    # Dosyaları yükle
    print("yekheld ile başlayan normalize edilmiş veri dosyaları yükleniyor...")
    
    input_files = [
        {"file_name": "yekheldbesmaturlu.csv", "output": "advekheldbesmaturlu.csv"},
        {"file_name": "yekheldcilizyeniyedi.csv", "output": "advekheldcilizyeniyedi.csv"},
        {"file_name": "yekheldcommonsuz.csv", "output": "advekheldcommonsuz.csv"},
        {"file_name": "yekhelddeznff.csv", "output": "advekhelddeznff.csv"},
        {"file_name": "yekheldff.csv", "output": "advekheldff.csv"},
        {"file_name": "yekheldflr.csv", "output": "advekheldflr.csv"},
        {"file_name": "yekheldgarabetaltiyedi.csv", "output": "advekheldgarabetaltiyedi.csv"},
        {"file_name": "yekheldkuponlu.csv", "output": "advekheldkuponlu.csv"},
        {"file_name": "yekheldkuponlukreciliz.csv", "output": "advekheldkuponlukreciliz.csv"},
        {"file_name": "yekheldkuponlukreorta.csv", "output": "advekheldkuponlukreorta.csv"},
        {"file_name": "yekheldnff.csv", "output": "advekheldnff.csv"},
        {"file_name": "yekheldotelremorta.csv", "output": "advekheldotelremorta.csv"},
        {"file_name": "yekheldsolidbig.csv", "output": "advekheldsolidbig.csv"},
        {"file_name": "yekheldtitrekhc.csv", "output": "advekheldtitrekhc.csv"},
        {"file_name": "yekhighmatur.csv", "output": "advekhighmatur.csv"},
        {"file_name": "yeknotbesmaturlu.csv", "output": "adveknotbesmaturlu.csv"},
        {"file_name": "yeknotcefilliquid.csv", "output": "adveknotcefilliquid.csv"},
        {"file_name": "yeknottitrekhc.csv", "output": "adveknottitrekhc.csv"},
        {"file_name": "yekrumoreddanger.csv", "output": "advekrumoreddanger.csv"},
        {"file_name": "yeksalakilliquid.csv", "output": "adveksalakilliquid.csv"},
        {"file_name": "yekshitremhc.csv", "output": "advekshitremhc.csv"}
    ]
    ...
    for file_info in input_files:
        ...
        try:
            if os.path.exists(file_name):
                ...
                print(f"OK {file_name} dosyası başarıyla yüklendi: {len(df)} satır")
                dataframes.append({
                    "df": df,
                    "input": file_name,
    ...
    if not dataframes:
        print("Hiçbir nekheld veri dosyası yüklenemedi. Program sonlandırılıyor.")
        return
    ...
    if len(processed_dfs) > 0:
        print("\nTüm veri setlerini birleştirme işlemi başlatılıyor...")
