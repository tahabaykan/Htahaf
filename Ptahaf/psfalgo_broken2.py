...
class PsfAlgo:
    ...
    def run_heldkup_fb(self):
        """HELDKUP FB - FINAL FB en yüksek 3 hisse → Front Buy"""
        print("[HELDKUP CHAIN 3/4] 🎯 HELDKUP FB → FINAL FB en yüksek 3 hisse → Front Buy")
        ...
        try:
            ...
            if hasattr(self.market_data, 'last_data') and ticker in self.market_data.last_data:
                ...
                try:
                    ...
                    if ticker in data:
                        md = data[ticker]
                        bid = float(md.get('bid', 0)) if md.get('bid') not in [None, 'N/
