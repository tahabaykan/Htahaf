# Ptahaf Uygulaması Detaylı Dokümantasyonu

## Genel Bakış
Ptahaf, hisse senedi işlemleri için geliştirilmiş kapsamlı bir otomasyon ve analiz uygulamasıdır. Uygulama, IBKR (Interactive Brokers) API'si ve Polygon.io API'si üzerinden veri çekme, emir gönderme ve pozisyon yönetimi işlemlerini gerçekleştirir.
...
- **Paste Ex-Div List**
  ...
  - Okunan/Kaydedilen CSV: `Ptahaf/exdivkayit/pDDMMYY.csv` (günlük dosya)
...
- **Load Ex-Div List**
  ...
  - Okunan CSV: `Ptahaf/exdivkayit/pDDMMYY.csv` (günlük dosya)
