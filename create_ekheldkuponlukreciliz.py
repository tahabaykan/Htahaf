...
tickers = [
    'ASB PRE','ASB PRF','BOH PRA','OZKAP','CADE PRA','DCOMP','FHN PRF','FULTP','MBINN','SYF PRA','TCBIO','WAFDP','SIGIP'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldkuponlukreciliz.csv', index=False)
print('ekheldkuponlukreciliz.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 