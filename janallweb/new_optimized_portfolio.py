...
def optimize_portfolio(portfolio_data, target_shares=40000, target_dollars=None):
    """
    ...
    def normalize_thg(value):
        ...
        return normalized ** 2  # Üs 2 kullanarak farkları artır
...
def process_file(input_file, output_file, num_stocks=50, max_stocks_per_company=2, target_shares=40000, target_dollars=None, group_limits=None):
    """
    ...
    target_shares : int, optional
        Hedef toplam hisse sayısı (default: 40000)
