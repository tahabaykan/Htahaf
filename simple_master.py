...
def main():
    ...
    # Script sırası
    scripts = [
        "ntreyield.py",                           # 1. Treasury yield'ları güncelle (US15Y dahil)
        "nyield_calculator.py",                   # 2. Yield hesaplamaları
        "update_normal_treasury_benchmark.py",    # 3. Normal Treasury benchmark'ları (yeni kupon aralıkları)
        "update_adjusted_treasury_benchmark.py",  # 4. Adjusted Treasury benchmark'ları (US15Y dahil)
        "add_adj_risk_premium.py"                 # 5. Adj Risk Premium (US15Y dahil)
    ]
