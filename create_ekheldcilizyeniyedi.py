...
tickers = [
    'MGRE','AHL PRF','BIPJ','BEPJ','CHSCN','CHSCM','CRBD','FGSN','F PRD','MBINL','TRTN PRF'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldcilizyeniyedi.csv', index=False)
print('ekheldcilizyeniyedi.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 