...
tickers = [
    'AGNCN','AGNCM','AGNCO','AGNCP','AQNB','ALL PRB','NLY PRI','NLY PRG','NLY PRF','CIM PRB','CIM PRD','CHSCL','CHSCO','C PRN','DRH PRA','DDT','DX PRC','FITBI','MS PRE','MS PRF','ONBPO','ONBPP','RITM PRA','RITM PRB','RITM PRC','SNV PRD','TWO PRC','VLYPP','VLYPO','WSBCP','EFC PRA'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldff.csv', index=False)
print('ekheldff.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 