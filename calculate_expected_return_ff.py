...
def main():
    try:
        # CSV dosyasını oku
        print("nekheldff.csv dosyası okunuyor...")
        df = pd.read_csv('nekheldff.csv', encoding='utf-8-sig')
        ...
        # Sonuçları göster
        print("\n=== BEKLENEN YILLIK GETİRİ SONUÇLARI (nekheldff.csv) ===")
        ...
        output_filename = 'expected_returns_ff_results.csv'
