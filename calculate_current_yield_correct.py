...
df['RISK_PREMIUM_NORM'] = np.clip(df['RISK_PREMIUM'], -5, 15)  # -5% ile 15% arası
...
result_df.to_csv('current_yield_analysis_final.csv', index=False)
print(f"\nSonuçlar 'current_yield_analysis_final.csv' dosyasına kaydedildi.") 