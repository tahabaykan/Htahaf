    ...
    <div className="truth-ticks-page">
      ...
      <div className="page-controls">
        ...
        <Link
          ...
          rel="noopener noreferrer"
          className="btn btn-secondary"
          style={{ textDecoration: 'none', display: 'inline-block', background: 'linear-gradient(135deg, #3b82f6 0%, #1d4ed8 100%)', color: 'white' }}
          title="Open Sidehit Press Flow Scanner in new tab"
        >
          📊 Sidehit Press
        </Link>
        ...
        <Link
          ...
          rel="noopener noreferrer"
          className="btn btn-secondary"
          style={{ textDecoration: 'none', display: 'inline-block', background: 'linear-gradient(135deg, #10b981 0%, #22c55e 100%)', color: 'white' }}
          title="Open Greatest MM Quant in new tab"
        >
          🎯 Greatest MM
        </Link>
