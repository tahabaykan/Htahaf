...
import SidehitPressPage from './pages/SidehitPressPage'
import GreatestMMPage from './pages/GreatestMMPage'
import LogViewerPage from './pages/LogViewerPage'
import IntraConPage from './pages/IntraConPage'
import './index.css'
  ...
  <React.StrictMode>
    <HashRouter>
      <Routes>
        ...
        <Route path="/sidehit-press" element={<SidehitPressPage />} />
        <Route path="/greatest-mm" element={<GreatestMMPage />} />
        <Route path="/logs" element={<LogViewerPage />} />
        <Route path="/intracon" element={<IntraConPage />} />
      </Routes>
    </HashRouter>
  </React.StrictMode>
)
