  ...
  if (!stocks || stocks.length === 0) {
    return (
      <div className="jfin-tab-empty">
        No SAS (Ask Sell) stocks selected
      </div>
    )
  }
        ...
        <table className="jfin-table">
          <thead>
            <tr>
              ...
              <th onClick={() => handleSort('final_sas_skor')} className="sortable">
                Final SAS Skor {sortConfig.key === 'final_sas_skor' && (sortConfig.direction === 'asc' ? ' ↑' : ' ↓')}
              </th>
