...
function JFINTabSFS({ stocks, onFilteredDataChange }) {
  ...
  if (!stocks || stocks.length === 0) {
    return <div className="jfin-tab-empty">No SFS (Soft Front Sell) stocks selected</div>
  }
        ...
        <table className="jfin-table">
          <thead>
            <tr>
              ...
              <th onClick={() => handleSort('final_sfs_skor')} className="sortable">Final SFS Skor {sortConfig.key === 'final_sfs_skor' && (sortConfig.direction === 'asc' ? ' ↑' : ' ↓')}</th>
