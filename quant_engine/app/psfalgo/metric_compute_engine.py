...
class MetricComputeEngine:
    ...
    def compute_metrics(
        ...
        # Overwrite with Janall Metrics (Group-based) if available
        # REMOVED: User requested "Homepage Logic" which is standard ETF-based Pricing Overlay.
        ...
        if janall_metrics:
            janall_bench = janall_metrics.get('benchmark_chg') or janall_metrics.get('bench_chg')
            if janall_bench is not None:
                 benchmark_chg = janall_bench
