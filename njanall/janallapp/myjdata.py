...
✅ DOĞRU: JDATA_FILE = get_csv_path("jdatalog.csv") (njanall dizininde)
❌ YANLIŞ: JDATA_FILE = "jdatalog.csv" (StockTracker dizininde)
=================================
"""
...
JDATA_FILE = get_csv_path("jdatalog.csv")  # njanall dizinindeki jdatalog.csv dosyasını kullan
...
def convert_jdatalog_to_pref_ibkr():
    """njanall dizinindeki jdatalog.csv'deki Hammer Pro formatındaki sembolleri PREF IBKR formatına çevir"""
    # njanall dizinindeki jdatalog.csv dosyasının yolu
    main_csv_path = get_csv_path("jdatalog.csv")
