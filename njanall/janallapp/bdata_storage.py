...
Bu modül BDATA ve BEFDAY CSV dosyalarını yönetir:
✅ DOĞRU: get_json_path("bdata_fills.json") (njanall dizininde)
❌ YANLIŞ: "bdata_fills.json" (StockTracker dizininde)
=================================
"""
...
from .path_helper import get_json_path, get_csv_path

BDATA_FILE = get_json_path('bdata_fills.json')
SNAPSHOT_FILE = get_json_path('bdata_snapshot.json')
    ...
    def update_csv(self):
        ...
        try:
            ...
            if csv_data:
                ...
                csv_path = get_csv_path('bdata.csv')
    ...
    def create_befday_csv(self, positions_data):
        ...
        try:
            ...
            if befday_data:
                ...
                csv_path = get_csv_path('befday.csv')
                df.to_csv(csv_path, index=False)
