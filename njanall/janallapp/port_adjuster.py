...
Örnek:
✅ DOĞRU: get_csv_path("exposureadjuster.csv") (njanall dizininde)
❌ YANLIŞ: "exposureadjuster.csv" (StockTracker dizininde)
=================================
"""
...
class PortAdjusterWindow:
    ...
    def load_settings_from_csv(self):
        ...
        try:
            # njanall dizinindeki exposureadjuster.csv'yi kullan
            csv_filename = get_csv_path('exposureadjuster.csv')
    ...
    def save_settings(self):
        ...
        try:
            ...
            # njanall dizinindeki CSV dosyasına kaydet
            csv_filename = get_csv_path('exposureadjuster.csv')
