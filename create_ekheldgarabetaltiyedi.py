...
tickers = [
    'AUB PRA','BC PRA','BC PRC','FHN PRE','HWCPZ','UCB PRI','PNFPP','UNMA','SR PRA','TRTN PRC','FITBP','WBS PRG'
]
...
pd.DataFrame(rows, columns=all_columns).to_csv('ekheldgarabetaltiyedi.csv', index=False)
print('ekheldgarabetaltiyedi.csv oluşturuldu (veriler öncelikli olarak nalltogether, nnotheldpff, alltogether; bulunamayanlar boş).') 